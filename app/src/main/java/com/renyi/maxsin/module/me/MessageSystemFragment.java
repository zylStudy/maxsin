...
/**
 * Created by zhangyuliang on 2018/3/22.系统消息
 *
 *
 */
...
public class MessageSystemFragment extends Basefragment {
    ...
    public static MessageSystemFragment getInstance(String type) {
        MessageSystemFragment ewsFragment = new MessageSystemFragment();
    ...
    protected void initView() {
        ...
        adapter = new CommonAdapter<MessageCourseBean.DataBean.ListBean>(getActivity(), R.layout.item_system_msg_layout, get_listAll) {
            @Override
            protected void convert(final ViewHolder viewHolder, MessageCourseBean.DataBean.ListBean item, final int position) {
                ...
                viewHolder.setText(R.id.info_tv,  item.getContent());
