...
public class MyActivityFragment extends Basefragment {
    ...
    public static MyActivityFragment getInstance(String type) {
        MyActivityFragment ewsFragment = new MyActivityFragment();
    ...
    protected void initView() {
        ...
        adapter = new CommonAdapter<GetBeans.DataBean.GetListBean>(getActivity(), R.layout.item_me_act_list, get_listAll) {
            @Override
            protected void convert(ViewHolder viewHolder, GetBeans.DataBean.GetListBean item, int position) {
                ...
                viewHolder.setText(R.id.likenum, item.getLike_count() + "人感兴趣");
                viewHolder.setText(R.id.joinnum, item.getBaoming_count() + "人已报名");
