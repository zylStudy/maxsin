...
public class TeacherListFragment extends Basefragment {
    ...
    public static TeacherListFragment getInstance(String type) {
        TeacherListFragment ewsFragment = new TeacherListFragment();
    ...
    private void loadDataFromSer() {
        ...
        mHttpHelper.post(Api.URL + "teacherlist", map, new BaseCallback<TeacherBeans>() {
            @Override
