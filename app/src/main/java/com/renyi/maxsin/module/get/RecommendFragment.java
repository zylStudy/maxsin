...
/**
 * Created by zhangyuliang on 2018/3/22.推荐
 * 课程
 */
...
public class RecommendFragment extends Basefragment {
    ...
    public static RecommendFragment getInstance(String type) {
        RecommendFragment ewsFragment = new RecommendFragment();
...
//                        loadDataFromSer();
        ...
        adapter = new CommonAdapter<GetBeans.DataBean.GetListBean>(getActivity(), R.layout.item_get_rem_list, get_listAll) {
            @Override
