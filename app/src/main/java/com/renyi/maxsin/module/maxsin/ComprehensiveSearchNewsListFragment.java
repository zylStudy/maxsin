...
import com.renyi.maxsin.module.maxsin.bean.NewsBeans;
...
public class ComprehensiveSearchNewsListFragment extends Basefragment {
    Bundle bundle;
    ...
    private int page = 1;
    private List<NewsBeans.DataBean.ListBean> get_listAll = new ArrayList<>();
    private NewsBeans.DataBean resultBeanData;
    String keywords = "";


    public static ComprehensiveSearchNewsListFragment getInstance(ArrayList<String> type) {
        ComprehensiveSearchNewsListFragment ewsFragment = new ComprehensiveSearchNewsListFragment();
    ...
    protected void initView() {
        ...
        adapter = new CommonAdapter<NewsBeans.DataBean.ListBean>(getActivity(), R.layout.item_me_coll_list, get_listAll) {
            @Override
            protected void convert(ViewHolder viewHolder, NewsBeans.DataBean.ListBean item, int position) {
                viewHolder.setText(R.id.title, item.getTitle());
                viewHolder.setText(R.id.info,  item.getDescription());
                viewHolder.setText(R.id.likenum, item.getCatname());
    ...
    private void loadDataFromSer() {
        ...
        mHttpHelper.post(Api.URL + "search_all", map, new BaseCallback<NewsBeans>() {
            @Override
            ...
            @Override
            public void onSuccess(Response response, NewsBeans resultBean) {
