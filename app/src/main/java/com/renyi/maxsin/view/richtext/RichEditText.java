package com.renyi.maxsin.view.richtext;
...
public class RichEditText extends ScrollView {
    ...
    private RemoveImageInterface removeImageInterface;

    public void setRemoveclickListener(RemoveImageInterface removeImageInterface) {
        this.removeImageInterface = removeImageInterface;
    }
    ...
    public void createImageView(final int index, final String url) {
        ...
        close.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                removeImageInterface.getRemoveImageInterface(url);
            }
        });
    ...
    public String buildHtml(RichEditText richEditText) {
        ...
        List<EditData> editList = richEditText.buildEditData();
